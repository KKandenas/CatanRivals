...
class EraOfTurmoilDrawDeck {
  ...
  /// Oroligheternas tids EGNA kort – till skillnad från [_drawPoolCards]
  /// utesluts INTE Värdshus här (det finns inga ansikte-upp-kort i det
  /// här läget), bara det antal [removeCounts] (nyckel =
